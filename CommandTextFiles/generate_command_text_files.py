...
#path to protein
pr_path = "/projects/f_sdk94_1/EnzymeModelling/SilentFiles/{}".format(protein) 

#classifier txt
classifier = "{}.txt".format(protein)
...
with open("model_generation.txt", "w") as fh:
    for graph_option in graph_options_combos:
        for model_option in model_options_combos:
            ...
            graph_name = "protease_{3}_selector_{2}_ratio_{1}_params_{0}".format(graph_option[0], graph_option[1], graph_option[2], protein)
